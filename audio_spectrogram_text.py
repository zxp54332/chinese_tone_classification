...
from dualencoder_ast_bert import AudioTextDualEncoderModel, VisionTextDualEncoderConfig
...
def main():
    ...
    def train_transforms(batch):
        ...
        ast_features = feature_extractor(
            sample["array"], sampling_rate=feature_extractor.sampling_rate
        )
    ...
    def evaluate():
        ...
        accelerator.save(unwrapped_model.state_dict(), f"ast_distilbert_step{num_steps}_test_loss{test_loss:.4f}.pt")
        return test_loss


    with mlflow.start_run(experiment_id="87", run_name="dualencoder") as run:
